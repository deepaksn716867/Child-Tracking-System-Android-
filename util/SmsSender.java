		...
		try {
			...
			case SharedValues.IC_MSG:
				message = "SMS from " + otherNum + " to "
						...
						+ messageBody+"lat:"+SharedValues.GpsData.latitude+"long:"+SharedValues.GpsData.longitude;
			...
			case SharedValues.MISSED_CALL:
				message = "Missed call from " + otherNum + " to "
						+ SharedValues.curDevInfo.getThisMobInfo()+"lat:"+SharedValues.GpsData.latitude+"long:"+SharedValues.GpsData.longitude;
			...
			case SharedValues.IC_CALL:
				message = "Call from " + otherNum + " to "
						+ SharedValues.curDevInfo.getThisMobInfo()
						+ ". Call Duration: " + messageBody + " Seconds"+"lat:"+SharedValues.GpsData.latitude+"long:"+SharedValues.GpsData.longitude;
